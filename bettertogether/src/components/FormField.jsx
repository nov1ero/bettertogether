    ...
    <label className="flex-1 w-full flex flex-col">
      ...
      {isTextArea ? (
        <textarea 
          ...
          className="py-[15px] sm:px-[25px] px-[15px] outline-none border-[1px] border-[#3a3a43] bg-[#9dabd1] font-epilogue text-black text-[14px] placeholder:text-[#4b5264] rounded-[10px] sm:min-w-[300px]"
        />
      ) : inputType === 'select' ? (
        <select
          required
